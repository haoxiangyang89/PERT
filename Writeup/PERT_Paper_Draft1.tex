...
\section{Illustration of Problem Properties via Examples} \label{sec:examples}
	...
	\begin{example} \label{eg:short}
		...
		%\\
		%\newline
		%This example shows that because the disruption may significantly change the duration of an activity, crashing shorter activities at the beginning of the project to prevent disruption may yield a significantly better result than crashing longer activities closer to the end of the project.
	\end{example}
...
%	Therefore, it is necessary to have decision variable \(t_i, \forall i \in I\) in model~\eqref{prob:extensive} in addition to the crashing decision variable \(x_{ij}, \forall i \in I, j \in J_i\). \\
%	\newline
