...
\begin{document}
	...
	\noi We align all test cases in the same scale and set the upper bound of FULL as 1 in Figure~\ref{fig:value}. It shows that the solution quality is poor without considering the uncertainty of disruption timing. The upper bound estimation of DET is at least \(30\%\) larger than that of FULL. The upper bound estimations of \(d\)Only and EXP are similar and at least \(10\%\) larger than that of FULL. For Case 14, the upper bound estimation of \(H\)Only is \(20\%\) larger than that of FULL. Although for other three cases, the upper bound estimation of \(H\)Only is close to that of FULL, the computational effort required to obtain \(H\)Only solution and the fully stochastic solution is on the same level, often much more. The test result justifies the value of having a fully stochastic model.
	...
	\begin{table}[H]
		...
		\resizebox{\linewidth}{!}{%
			\begin{tabular}{ c | l l l l l l }
				\hline
				& \multicolumn{1}{c}{10} & \multicolumn{1}{c}{20} & \multicolumn{1}{c}{50} & \multicolumn{1}{c}{100} & \multicolumn{1}{c}{200} & \multicolumn{1}{c}{500}  \\ \hline
	...
	\begin{table}[H]
		...
		\begin{tabular}{ c | c | l l l | r}
			...
			\hline
			\multirow{3}{*}{Case 11} & 100 & 0.01	& 0.5	& 2.3	& 5.6\\
			...
			\hline
			\multirow{3}{*}{Case 35} & 100 & 0	& 0.64	& 2.65	& 5.8\\
